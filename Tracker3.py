...
# Servicio que gestiona la descarga de un archivo- DESCARGAS DE FORMA DISTRIBUIDA
...
if __name__ == '__main__':
   app.run(port=5000, host="192.168.191.224", debug=True, threaded=True) #IP del equipo en red destinado a server.
   # ZeroTier -> Rojo principal: 192.168.191.159